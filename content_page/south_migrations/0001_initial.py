...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Page'
        db.create_table(u'content_page_page', (
            (u'content_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['content.Content'], unique=True, primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content_page.Page'], null=True, blank=True)),
            ('template', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'content_page', ['Page'])


    def backwards(self, orm):
        # Deleting model 'Page'
        db.delete_table(u'content_page_page')
    ...
    models = {
        ...
        u'content_page.page': {
            'Meta': {'ordering': "['-date_modified']", 'object_name': 'Page', '_ormbases': [u'content.Content']},
            u'content_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['content.Content']", 'unique': 'True', 'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content_page.Page']", 'null': 'True', 'blank': 'True'}),
